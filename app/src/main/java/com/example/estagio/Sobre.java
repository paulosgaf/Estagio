...
public class Sobre extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_adicionar_estagio) {
            ...
            Intent intent = new Intent (Sobre.this, AdicionarVaga.class);
            startActivity(intent);
        } else if (id == R.id.nav_perfil) {

            Intent intent = new Intent (Sobre.this, Perfil.class);
            startActivity(intent);
        } else if (id == R.id.nav_ajuda) {

            Intent intent = new Intent (Sobre.this, Ajuda.class);
            startActivity(intent);
    ...
    public void clicouFavorito(View view){
        ...
        Intent intent = new Intent (Sobre.this, Favoritos.class);
        startActivity(intent);
    }
    ...
    public void clicouVagas(View view){
        ...
        Intent intent = new Intent (Sobre.this, Vagas.class);
        startActivity(intent);
    }
