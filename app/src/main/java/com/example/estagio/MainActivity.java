...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //adiciona a transação para o MapsFragment
        transaction.add(R.id.container, new MapsFragment(), "MapsFragment");
        //confirmar transação
        transaction.commitAllowingStateLoss();
    }

//volta a barra lateral quando o botão back é pressioando
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_adicionar_estagio) {
            ...
            Intent intent = new Intent (MainActivity.this, AdicionarVaga.class);
    ...
    public void clicouVagas(View view){
        ...
        Intent intent = new Intent (MainActivity.this, Vagas.class);
        startActivity(intent);
    }
