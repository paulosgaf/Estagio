...
public class Favoritos extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_adicionar_estagio) {
            ...
            Intent intent = new Intent (Favoritos.this, AdicionarVaga.class);
            ...
            Intent intent = new Intent (Favoritos.this, Sobre.class);
            startActivity(intent);
        }
    ...
    public void clicouVagas(View view){
        ...
        Intent intent = new Intent (Favoritos.this, Vagas.class);
        startActivity(intent);
    }
}
